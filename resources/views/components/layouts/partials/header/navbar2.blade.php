      ...
      <div class="row align-items-center row-bg1">
                      ...
                      <div class="row gx-4 row-cols-1 row-cols-md-1 row-cols-lg-4">
                        <div class="col">
                          <div class="vl-home-thumb">
                            ...
                            <div class="btn-area1">
                              <a href="{{ route('any' , 'index') }}" class="vl-btn2">View Demo</a>
                            </div>
                        ...
                        <div class="col">
                          <div class="vl-home-thumb">
                            ...
                            <div class="btn-area1">
                              <a href="{{ route('second', ['demo', 'index2']) }}" class="vl-btn2">View Demo</a>
                            </div>
                            <div class="space20 d-lg-none d-block"></div>
                          </div>
                        </div>
                        <div class="col">
                          <div class="vl-home-thumb">
                            ...
                            <div class="btn-area1">
                              <a href="{{ route('second', ['demo', 'index3']) }}" class="vl-btn2">View Demo</a>
                            </div>
                            <div class="space20 d-lg-none d-block"></div>
                          </div>
                        </div>
                        <div class="col">
                          <div class="vl-home-thumb">
                            ...
                            <div class="btn-area1">
                              <a href="{{ route('second', ['demo', 'index4']) }}" class="vl-btn2">View Demo</a>
                            </div>
                            <div class="space20 d-lg-none d-block"></div>
                          </div>
                        </div>
        ...
        <div class="col-lg-3 col-md-6 col-6">
          <div class="vl-hero-btn d-none d-lg-block text-end">
            ...
            <span class="vl-btn-wrap text-end"><a href="{{ route('second', ['pages', 'contact']) }}" class="vl-btn2">Work With Us</a></span>
          </div>
