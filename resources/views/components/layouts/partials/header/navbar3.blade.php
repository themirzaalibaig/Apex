    ...
    <div class="container">
      <div class="row align-items-center row-bg1">
        ...
        <div class="col-lg-6 d-none d-lg-block">
          <div class="vl-main-menu text-start">
              ...
              <ul>
                      ...
                      <div class="row gx-4 row-cols-1 row-cols-md-1 row-cols-lg-4">
                        <div class="col">
                          <div class="vl-home-thumb">
                            ...
                            <div class="btn-area1">
                              <a href="{{ route('any' , 'index') }}" class="vl-btn1">View Demo</a>
                        ...
                        <div class="col">
                          <div class="vl-home-thumb">
                            ...
                            <div class="btn-area1">
                              <a href="{{ route('second', ['demo', 'index2']) }}" class="vl-btn1">View Demo</a>
                        ...
                        <div class="col ">
                          <div class="vl-home-thumb">
                            ...
                            <div class="btn-area1">
                              <a href="{{ route('second', ['demo', 'index3']) }}" class="vl-btn1">View Demo</a>
                        ...
                        <div class="col ">
                          <div class="vl-home-thumb">
                            ...
                            <div class="btn-area1">
                              <a href="{{ route('second', ['demo', 'index4']) }}" class="vl-btn1">View Demo</a>
                ...
                <li class="has-dropdown">
                  ...
                  <ul class="sub-menu">
                    ...
                    <li><a href="{{ route('second', ['pages', 'team']) }}">Our Team</a></li>
                    <li><a href="{{ route('second', ['pages', 'testimonial']) }}">Testimonials</a></li>
                    <li><a href="{{ route('second', ['pages', 'contact']) }}">Contact Us</a></li>
                    <li><a href="{{ route('second', ['pages', 'faq']) }}">FAQ,s</a></li>
                ...
                <li><a href="#">Services <span><i class="fa-solid fa-angle-down d-lg-inline d-none"></i></span></a>
                  <ul class="sub-menu">
                    <li><a href="{{ route('second', ['services', 'service']) }}">Our Service</a></li>
                ...
                <li><a href="#">Project <span><i class="fa-solid fa-angle-down d-lg-inline d-none"></i></span></a>
                  <ul class="sub-menu">
                    <li><a href="{{ route('second', ['projects', 'project']) }}">Project</a></li>
                    <li><a href="{{ route('second', ['projects', 'single']) }}">Project Single</a></li>
                  </ul>
                </li>
                <li><a href="#">Blogs <span><i class="fa-solid fa-angle-down d-lg-inline d-none"></i></span></a>
                  <ul class="sub-menu">
                    <li><a href="{{ route('second', ['blogs', 'blog']) }}">Blog One</a></li>
                    <li><a href="{{ route('second', ['blogs', 'blog2']) }}">Blog Two</a></li>
        ...
        <div class="col-lg-4 col-md-6 col-6">
          <div class="vl-hero-btn d-none d-lg-block text-end">
            ...
            <span class="vl-btn-wrap text-end">
              <a href="{{ route('second', ['pages', 'contact']) }}" class="vl-btn1" style="overflow: hidden;">Let’s Build Together</a>
            </span>
