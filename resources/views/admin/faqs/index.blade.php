...
<div class="p-6">
    ...
    <div class="flex justify-between items-center mb-6">
        <div>
            <flux:heading size="xl">FAQs Management</flux:heading>
            <flux:text class="mt-2">Manage frequently asked questions</flux:text>
        </div>
        <flux:button variant="primary" icon="plus" href="{{ route('faqs.create') }}" wire:navigate>
            Add New FAQ
        </flux:button>
    </div>
                        ...
                        <tr>
                            <td colspan="4" class="px-6 py-12 text-center">
                                <div class="flex flex-col items-center">
                                    <i class="fas fa-question-circle text-4xl text-zinc-400 dark:text-zinc-500 mb-4"></i>
                                    ...
                                    <flux:button variant="primary" icon="plus" href="{{ route('faqs.create') }}">
                                        Add FAQ
                                    </flux:button>
                                </div>
                            </td>
