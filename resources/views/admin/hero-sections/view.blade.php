    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-6 flex items-center justify-between">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <flux:heading size="xl">{{ $heroSection->subtitle }}</flux:heading>
                    <flux:text class="text-zinc-500 dark:text-zinc-400 mt-1">Hero Section Details</flux:text>
                </div>
            </div>
                ...
                <div class="bg-white dark:bg-zinc-800 rounded-xl shadow-lg border border-zinc-200 dark:border-zinc-700 overflow-hidden">
                    <div class="px-6 py-4 border-b border-zinc-200 dark:border-zinc-700 bg-zinc-50 dark:bg-zinc-700/50">
                        <div class="flex items-center gap-2">
                            ...
                            <h3 class="text-lg font-semibold text-zinc-900 dark:text-white">Hero Section Details</h3>
                        </div>
                    </div>

                    <div class="p-6 space-y-6">
                        <div>
                            <flux:label class="text-zinc-700 dark:text-zinc-300 font-medium mb-2">Subtitle</flux:label>
                            <p class="text-zinc-600 dark:text-zinc-400">{{ $heroSection->subtitle }}</p>
                        </div>

                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <flux:label class="text-zinc-700 dark:text-zinc-300 font-medium mb-2">Title Line 1</flux:label>
                                <p class="text-zinc-600 dark:text-zinc-400">{{ $heroSection->title1 }}</p>
                            </div>

                            <div>
                                <flux:label class="text-zinc-700 dark:text-zinc-300 font-medium mb-2">Title Line 2</flux:label>
                                <p class="text-zinc-600 dark:text-zinc-400">{{ $heroSection->title2 }}</p>
                            </div>
                        </div>

                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <flux:label class="text-zinc-700 dark:text-zinc-300 font-medium mb-2">CTA Button Text</flux:label>
                                <p class="text-zinc-600 dark:text-zinc-400">{{ $heroSection->cta }}</p>
                            </div>

                            <div>
                                <flux:label class="text-zinc-700 dark:text-zinc-300 font-medium mb-2">CTA Button URL</flux:label>
                                <a href="{{ $heroSection->cta_url }}" target="_blank" class="text-blue-600 dark:text-blue-400 hover:underline flex items-center gap-1">
                                    {{ $heroSection->cta_url }}
                    ...
                    <div class="p-6 space-y-4">
                        <div>
                            ...
                            <p class="text-zinc-900 dark:text-white font-medium">
                                {{ $heroSection->created_at->format('M d, Y h:i A') }}
                            </p>
                        </div>
                        ...
                        <div class="pt-4 border-t border-zinc-200 dark:border-zinc-700">
                            ...
                            <p class="text-zinc-900 dark:text-white font-medium">
                                {{ $heroSection->updated_at->format('M d, Y h:i A') }}
                            </p>
                        </div>
