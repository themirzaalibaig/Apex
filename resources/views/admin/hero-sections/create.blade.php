            ...
            <div class="px-6 py-4 border-b border-zinc-200 dark:border-zinc-700 bg-zinc-50 dark:bg-zinc-700/50">
                <div class="flex items-center gap-3">
                    <div class="w-10 h-10 bg-zinc-100 dark:bg-zinc-900/30 rounded-lg flex items-center justify-center">
                        <flux:icon name="sparkles" class="w-5 h-5 text-zinc-600 dark:text-zinc-400" />
                    </div>
                    <div>
                        <h3 class="text-lg font-semibold text-zinc-900 dark:text-white">Create New Hero Section</h3>
                        <p class="text-sm text-zinc-500 dark:text-zinc-400">Fill in the information below to create a hero section</p>
                    </div>
                </div>
            </div>

            <!-- Card Body -->
            <form action="{{ route('hero-sections.store') }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-8">
                @csrf
