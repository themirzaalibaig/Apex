        ...
        <div class="bg-white dark:bg-zinc-800 rounded-xl shadow-lg border border-zinc-200 dark:border-zinc-700 overflow-hidden">
            ...
            <div class="px-6 py-4 border-b border-zinc-200 dark:border-zinc-700 bg-zinc-50 dark:bg-zinc-700/50">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h3 class="text-lg font-semibold text-zinc-900 dark:text-white">Create New About Section</h3>
                        <p class="text-sm text-zinc-500 dark:text-zinc-400">Fill in the information below to create your about section</p>
                    </div>
                </div>
            </div>

            <!-- Card Body -->
            <form action="{{ route('abouts.store') }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-8">
                @csrf
                ...
                <div class="space-y-6">
                    ...
                    <!-- Video Upload -->
                    <div class="space-y-2">
                        <flux:label for="video" required class="text-zinc-700 dark:text-zinc-300 font-medium">Video</flux:label>
                        <flux:input
                            type="file"
                            id="video"
                            name="video"
