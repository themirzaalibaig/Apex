<div class="service1-section-area sp6"
    style="background-image: url(/img/all-images/bg/bg3.png); background-position: center; background-size: cover; background-repeat: no-repeat;">
    <div class="container">
        <div class="row">
            <div class="col-lg-5 m-auto">
                <div class="service-header heading1 text-center space-margin60">
                    <h5><img src="/img/icons/sub-logo2.svg" alt="" />Excellence in Every Pixel</h5>
                    <div class="space20"></div>
                    <h2 class="text-anime-style-3">Innovative Services for Modern Brands</h2>
                </div>
            </div>
        </div>
