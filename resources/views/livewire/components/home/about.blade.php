              ...
              <div class="col-lg-6">
                  <div class="images">
                      <div class="img1 reveal">
                          @php
                              $mainImage = $about?->mediaByType('main') ?? $about?->mediaFirst();
                          @endphp
                          <img src="{{ $mainImage?->url ?? asset('img/all-images/about/about-img1.png') }}" alt="" />
                      </div>
              ...
              <div class="col-lg-6">
                  <div class="about-header heading1">
                      ...
                      <div class="btn-area1" data-aos="fade-left" data-aos-duration="1100">
                          <a href="{{ $about?->cta_url ?? '#' }}" class="vl-btn1" style="overflow: hidden;">{{ $about?->cta ?? 'Learn More' }}</a>
                      </div>
                  </div>
              </div>
          </div>
